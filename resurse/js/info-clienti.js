...
class GrupIngrediente extends React.Component {
  ...
  updateCantitati(infoIngredient){ //infoIngredient are tipul de numele cantitatea si semnul pentru update
    ...
    var msg = "";
    if (this.totalCalorii <= 200) msg = mesaje[200];
    else if (this.totalCalorii <= 500) msg = mesaje[500];
    else if (this.totalCalorii <= 1000) msg = mesaje[1000];
    else if (this.totalCalorii <= 2000) msg = mesaje[2000];
    else msg = "Peste limita";
    this.mesaj= msg;
  ...
  render(){
    ...
    rez.push(React.createElement("p",null,`Total calorii: ${this.totalCalorii} ${this.mesaj}`))
  return rez;
  }
}
...
class Reset extends React.Component{
  ...
  render(){
    return React.createElement("button",{onClick:this.Reset},`Resetare`)
  }
}
